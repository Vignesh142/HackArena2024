...
class TextToSpeech:
    ...
    def speak(self, text):
        ...
        # Create a path for the audio file in the current directory
        output_file = os.path.join(os.getcwd(), "output_audio.wav")
        ...
        with requests.post(DEEPGRAM_URL, stream=True, headers=headers, json=payload) as r:
            ...
            if r.status_code != 200:
                print(
                    f"Error: Unable to get audio. Status code {r.status_code} - {r.text}")
                return
            ...
            self.play_stream_from_file(output_file)

    def play_stream_from_file(self, audio_file):
